  ...
  <div class="app-wrapper">
    <div class="constuctor-inputs">
      <div class="constuctor-inputs__group">
        ...
        <div class="constuctor-inputs__group" v-for="(passenger, index) in passengers" :key="index">
          ...
          />
          <button class="btn" @click="removePassenger(index)">Remove pass -</button>
        </div>
      </div>
      <div class="constuctor-inputs__group">
        <h3>Данные заказчика</h3>
        <label for="passengerPhone">Телефон</label>
        <input placeholder="+19876543212" name="passengerPhone" type="text" v-model="passengerPhone" />
        <label for="passengerEmail">E-mail</label>
        <input placeholder="example@example.com" name="passengerEmail" type="text" v-model="passengerEmail" />
      </div>
      <div class="wrap">
        <div class="constuctor-inputs__group">
          <h3>Данные отправления</h3>
          <label for="fromCity">Откуда (Город)</label>
          <input placeholder="Moscow" name="fromCity" type="text" v-model="fromCity" />
          <label for="fromAeroCode">Откуда (Код аэропорта)</label>
          <input placeholder="SVO" name="fromAeroCode" type="text" v-model="fromAeroCode" />
          <label for="fromCountry">Откуда (Страна)</label>
          <input placeholder="USSR" name="fromCountry" type="text" v-model="fromCountry" />
          <label for="aviacompanyFrom">Авиакомпания</label>
          <input placeholder="Aeroflot" name="aviacompanyFrom" type="text" v-model="aviacompanyFrom" />
        ...
        <div class="constuctor-inputs__group">
          ...
          <input placeholder="Berlin" name="toCity" type="text" v-model="toCity" />
          <label for="toAeroCode">Куда (Код аэропорта)</label>
          <input placeholder="BER" name="toAeroCode" type="text" v-model="toAeroCode" />
          <label for="toCountry">Куда (Страна)</label>
          <input placeholder="Germany" name="toCountry" type="text" v-model="toCountry" />
          <label for="aviacompanyTo">Авиакомпания</label>
          <input placeholder="Aeroflot" name="aviacompanyTo" type="text" v-model="aviacompanyTo" />
          <label for="toTime">Время прилета</label>
          <input name="toTime" placeholder="чч:мм" type="text" v-model="toTime" @input="formatTimeInput('toTime')" />
      ...
      <div class="wrap" v-if="!!roundTrip">
        <div class="constuctor-inputs__group">
          <h3>Данные отправления</h3>
          <label for="fromCity">Откуда (Город)</label>
          <input placeholder="Moscow" name="fromCity" type="text" v-model="fromCity2" />
          <label for="fromAeroCode">Откуда (Код аэропорта)</label>
          <input placeholder="SVO" name="fromAeroCode" type="text" v-model="fromAeroCode2" />
          <label for="fromCountry">Откуда (Страна)</label>
          <input placeholder="USSR" name="fromCountry" type="text" v-model="fromCountry2" />
          <label for="aviacompanyFrom">Авиакомпания</label>
          <input placeholder="Aeroflot" name="aviacompanyFrom" type="text" v-model="aviacompanyFrom2" />
          <label for="fromTime">Время вылета</label>
          <input
            name="fromTime"
            placeholder="чч:мм"
        ...
        <div class="constuctor-inputs__group">
          <h3>Данные прибытия</h3>
          <label for="toCity">Куда (Город)</label>
          <input placeholder="Berlin" name="toCity" type="text" v-model="toCity2" />
          <label for="toAeroCode">Куда (Код аэропорта)</label>
          <input placeholder="BER" name="toAeroCode" type="text" v-model="toAeroCode2" />
          <label for="toCountry">Куда (Страна)</label>
          <input placeholder="Germany" name="toCountry" type="text" v-model="toCountry2" />
          <label for="aviacompanyTo">Авиакомпания</label>
          <input placeholder="Aeroflot" name="aviacompanyTo" type="text" v-model="aviacompanyTo2" />
          <label for="toTime">Время прилета</label>
          <input name="toTime" placeholder="чч:мм" type="text" v-model="toTime2" @input="formatTimeInput('toTime2')" />
          <label for="toDate">Дата прилета</label>
      ...
      <div class="constuctor-inputs__group">
        ...
        <input placeholder="1" name="countCabinBag" type="text" v-model="countCabinBag" />
        <label for="weightCabinBag">Вес ручного багажа</label>
        <input placeholder="10" name="weightCabinBag" type="text" v-model="weightCabinBag" />
        ...
        <input placeholder="1" name="countCheckedBag" type="text" v-model="countCheckedBag" />
        <label for="weightCheckedBag">Вес сдаваемого багажа</label>
        <input placeholder="10" name="weightCheckedBag" type="text" v-model="weightCheckedBag" />
